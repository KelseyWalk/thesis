...
min_pm25 <- quantile(data_daily$pm25, probs = 0.05) #5th quantile
max_pm25 <- quantile(data_daily$pm25, probs = 0.95)#95th quantile

# CO2
dmc_co2 <- 1000 #ppm
min_co2 <- quantile(data_daily$co2, probs = 0.05) #5th
max_co2 <- quantile(data_daily$co2, probs = 0.95) #95th

# VOC
dmc_voc <- 200 #micrograms/m3
min_voc <- quantile(data_daily$voc, probs = 0.05) #5th
max_voc <- quantile(data_daily$voc, probs = 0.95) #95th

# T
min_t <- quantile(data_daily$temp, probs = 0.05) #5th
max_t <- quantile(data_daily$temp, probs = 0.95) #95th

#RH
min_h <- quantile(data_daily$humid, probs = 0.05) #5th
max_h <- quantile(data_daily$humid, probs = 0.95) #95th

...
```{r include = FALSE}
assessment <- read_excel("~kelseywalker/Desktop/EPIC HOMES/house_characteristics_assessment/h_charact.xlsx", sheet = "LBL Model_ela_new") 
...
p_houses_1 <- grid.arrange(p1, p2, p3, p5, p6, p7, p10, p11, p12, p14, p15, p16, nrow = 3) #round 1

p_houses_2 <- grid.arrange(p17, p18, p19, p20, p22, p23, p25, p26, p27, p28, nrow = 3) #round 2
```


```{r, include = FALSE}
###### Save above Time Series Plots (pdf)
ggsave(filename = "lbl_individual_houses_line.pdf", plot = p_houses_1)
```

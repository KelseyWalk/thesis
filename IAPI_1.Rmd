...
data2 <- dplyr::bind_rows(living,kitchen) %>%
...
```{r}
# dmc 2/5/22
# quanitles, ecdf linear interpolation 2/5/22

# PM 2.5
dmc_pm25 <- 15 #micrograms/m3 
min_pm25 <- 1.05 #5th quantile
max_pm25 <- 25.12 #95th quantile

# VOC
dmc_voc <- 200 #micrograms/m3 = ppb
min_voc <- 99.32 #5th
max_voc <- 1082.09 #95th

# CO2
dmc_co2 <- 1000 #ppm
min_co2 <- 457.13 #5th
max_co2 <- 1117.34 #95th
...
ggplot(data = home1, aes(date, IAPI)) + 
  geom_point() +
  geom_point(aes(date, pm25_percent, color = "pm25")) + 
  geom_point(aes(date, co2_percent, color = "co2")) +
  geom_point(aes(date, voc_percent, color = "voc"))
